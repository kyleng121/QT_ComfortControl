...
void MainWindow::on_lightOnBtn_toggled(bool checked)
{
    ui->lightLog->setText("Light On");
}


void MainWindow::on_lightOffBtn_toggled(bool checked)
{
    ui->lightLog->setText("Light Off");
}
